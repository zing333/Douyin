...
public class GPUImageToneCurveFilter extends GPUImageFilter {
    ...
    private int mToneCurveTextureUniformLocation = getUniformLocation("toneCurveTexture");
    ...
    protected void onDrawArraysPre() {
        if (this.mToneCurveTexture[0] != -1) {
            GLES20.glActiveTexture(33987);
            GLES20.glBindTexture(3553, this.mToneCurveTexture[0]);
            GLES20.glUniform1i(getPhysUniformLocation(this.mToneCurveTextureUniformLocation), 3);
        }
    }
    ...
    public PointF[] getRgbCompositeControlPoints() {
        return this.mRgbCompositeControlPoints;
    }
