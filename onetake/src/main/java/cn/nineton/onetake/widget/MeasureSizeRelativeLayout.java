...
public class MeasureSizeRelativeLayout extends RelativeLayout {
    ...
    public MeasureSizeRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MeasureSizeRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (this.onSizeChange != null) {
            this.onSizeChange.size(getMeasuredHeight(), getMeasuredWidth(), oldw, oldh);
        }
    }
